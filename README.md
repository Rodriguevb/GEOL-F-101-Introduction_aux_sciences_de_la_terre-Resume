# Résumé du cours GEOL-F101 - Introduction aux sciences de la terre

## Qu'est-ce donc ce répertoire ?
Ce répertoire contient le résumé en PDF (via LaTeX) du cours GEOL-F101 - Introduction aux sciences de la terre de l'Université Libre de Bruxelles. Ce résumé dispose de la même table des matières que le cours (dans la mesure du possible).
